...
public class boi_PinPage {
    ...
    By pinNum6 = By.cssSelector ("#C2__C2__C1__QUE_188DA78A3B0DB18F2505");
    ...
    public void enterPAC() throws InterruptedException {
        ...
        if(elementPinNum1.isEnabled()) {
            driver.findElement(pinNum1).sendKeys("0");
            Thread.sleep(1000);
        }
        ...
        if(elementPinNum6.isEnabled()) {
            ...
            System.out.println("INCORRECT PIN !! RE-RUN YOUR TESTS");
        }
    }
